...
void
byteswap_uint64_array(void *vbuf, uint32_t size)
{
	uint64_t *buf = vbuf;
	size_t count = size >> 3;
	int i;
...
void
byteswap_uint32_array(void *vbuf, uint32_t size)
{
	uint32_t *buf = vbuf;
	size_t count = size >> 2;
	int i;
...
void
byteswap_uint16_array(void *vbuf, uint32_t size)
{
	uint16_t *buf = vbuf;
	size_t count = size >> 1;
	int i;
...
/* ARGSUSED */
void
byteswap_uint8_array(void *vbuf, uint32_t size)
{
}
